...
%                 PDS.fixOverlap(c.j) = c.fixOverlap;
          ...
          %  elseif c.fixreq == 2
                ...
                tstate_back = 0.005;
                t.strobeOnFlip.logic = true;
                t.strobeOnFlip.value = 999999999;
                c.loopCountOfTargetOn =t.wlCount;
          %  end
...
%                 Datapixx('RegWrRd');
%              
%                 Datapixx('SetDacSchedule', 0, [1000,1], 1000, c.outcomechannel);
%                 
...
%     
    ...
    if t.strobeOnFlip.value==999999999 && t.strobeOnFlip.logic ==1
        t.timeTARGETON     = t.lastframetime;
    end
    
    if t.strobeOnFlip.value==0.00557 && t.strobeOnFlip.logic ==1
