...
RewardHist1(1:c.rew_mag_offer1*c.maxValrange)=1; RewardHist1_1(1:100-c.rew_mag_offer1*c.maxValrange)=0;
RewardHist1=([RewardHist1 RewardHist1_1]); RewardHist1=RewardHist1(randperm(length(RewardHist1)));

RewardHist2(1:c.rew_mag_offer2*c.maxValrange)=1; RewardHist2_1(1:100-c.rew_mag_offer2*c.maxValrange)=0;
RewardHist2=([RewardHist2 RewardHist2_1]); RewardHist2=RewardHist2(randperm(length(RewardHist2)));

DelayHist1(1:c.delay_mag_offer1*c.maxValrange)=1; DelayHist1_1(1:100-c.delay_mag_offer1*c.maxValrange)=0;
DelayHist1=([DelayHist1 DelayHist1_1]); DelayHist1=DelayHist1(randperm(length(DelayHist1)));

DelayHist2(1:c.delay_mag_offer2*c.maxValrange)=1; DelayHist2_1(1:100-c.delay_mag_offer2*c.maxValrange)=0;
