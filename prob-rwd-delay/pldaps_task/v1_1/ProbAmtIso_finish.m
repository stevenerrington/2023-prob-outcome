...
%     c.PDS.proportionalstableWindow = proportionalstableWindow;
    ...
    set(c.plotaxpupil(fractalIndex), 'XLim', [0 c.rwd_delay+minITI_dur]);
...
set (c.plotdata(plotPositions(1)),{'XData'}, {[1:(size(meansOfFocusTime,2)+2)]} , ...
    {'YData'}, {[(meansOfFocusTime/c.rwd_delay) ,0, (PDS.timeFocused(c.j)/c.rwd_delay)  ]} );
...
try
        ...
        %
        set(c.CsOffPlotLine(plotIdentifier), 'XData', [c.rwd_delay  c.rwd_delay]  );
