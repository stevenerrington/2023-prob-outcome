...
s.fixDur  = 0.5;
c.reveal_first_idx = randi([1,2]); % MOVE THIS?
...
if  c.chosen==1
    ...
    PtpWindW    =  deg2pix(1,c); % target point window width
    PtpWindH    =  deg2pix(n,c); % target point window height
    Screen('FrameRect',c.window, pun_reveal_color,repmat(t.ang1  + c.middleXYtt,1,2) + [-PtpWindW -PtpWindH PtpWindW PtpWindH*0],5)
    ...
    elseif  c.punishdel==1
        ...
        PtpWindW    =  deg2pix(1,c); % target point window width
        PtpWindH    =  deg2pix(n,c); % target point window height
        Screen('FrameRect',c.window, rwd_reveal_color,repmat(t.ang1  + c.middleXYt,1,2) + [-PtpWindW -PtpWindH PtpWindW PtpWindH*0],5)
...
if  c.chosen==2
    ...
    PtpWindW    =  deg2pix(1,c); % target point window width
    PtpWindH    =  deg2pix(n,c); % target point window height
    Screen('FrameRect',c.window, pun_reveal_color,repmat(t.ang2  + c.middleXYtt,1,2) + [-PtpWindW -PtpWindH PtpWindW PtpWindH*0],5)
    ...
    elseif  c.punishdel==1
        ...
        PtpWindW    =  deg2pix(1,c); % target point window width
        PtpWindH    =  deg2pix(n,c); % target point window height
        Screen('FrameRect',c.window, rwd_reveal_color,repmat(t.ang2  + c.middleXYt,1,2) + [-PtpWindW -PtpWindH PtpWindW PtpWindH*0],5)
