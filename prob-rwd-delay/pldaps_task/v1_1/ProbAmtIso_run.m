  ...
  case 0.0001
        ...
        case 0.25
            ...
            elseif t.ttime >= t.timeFPON + s.fixDur
                t.state       = 0.0055;
                %                 c.repeatflag=0;
                %NML removed to enabel overlap trials. set at random?
            end
        ...
        case 999905
            if (GetSecs - delayvar) >= 1; %c.intraoutcome_interval;
...
if offer_rwd == 0
    c.RewardRange_outcome = c.small_reward_cuesize;
else
    c.RewardRange_outcome = c.large_reward_cuesize;    
end
